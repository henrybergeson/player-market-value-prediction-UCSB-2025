...
library(readxl)
library(readxl)
Passing_Data <- read_excel("C:/Users/2chas/Downloads/Data Science Project/Passing Data.xlsx")
head(Passing_Data)
...
library(readxl)
player_Data <- read_excel("C:/Users/2chas/Downloads/NFL Salary Data.xlsx")
Passing_Data <- read_excel("C:/Users/2chas/Downloads/Data Science Project/Passing Data.xlsx")
head(Passing_Data)
sum(!complete.cases(Passing_Data))
Passing_Data$Salary[is.na(Passing_Data$Salary)] <- median(Passing_Data$Salary, na.rm = TRUE)
...
library(dplyr)
df2Select <- player_Data %>% select(Player, Salary)
